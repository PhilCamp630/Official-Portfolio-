...
const Data = () => {
  return (
    <div className="homer_data">
      <h1 className="home_title">Phillip Campbell
        <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
      ...
      <p className="home_description">A blossoming developer with a passion for learning and coding</p>
